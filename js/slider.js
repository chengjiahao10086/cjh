...
Slider02.prototype.createUI = function(){
	...
	let ulDom = document.createElement("ul");
	ulDom.style.cssText = "position:absolute;left:50%;margin-left:-this.width/2+'px';list-style:none;margin:0 auto;bottom:10px;z-index:1;";
	this.boxDom.appendChild(ulDom);
...
Slider02.prototype.stop=function(){
	...
	//3、跳转指定的图片
	//
Slider02.prototype.goImg=function(transIndex){//2
	//1、改变数据（图片序号）
	let outIndex = this.currIndex;
	this.currIndex=transIndex;//2
	//2、边界处理
